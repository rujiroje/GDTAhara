...
const DataForm = ({ item, type, onSave, onCancel }) => {
    ...
    const renderFields = () => {
        switch (type) {
            ...
            default: // users
                const roles = ['DataAdmin', 'Production Control', 'Shift Leader', 'Operator', 'Technician', 'QA', 'CM Operator'];
...
const ImportData = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setError(err.response?.data || 'เกิดข้อผิดพลาดในการนำเข้าข้อมูล');
        }
        setLoading(false);
        setCurrentUpload('');
        setFile(null);
    ...
    return (
        <div>
            ...
            <div className="import-container">
                ...
                <Uploader type="parameter-checklists" label="ข้อมูล Parameter Checklist (Parameter.csv)" />
            </div>
        </div>
    );
};
...
const AdminDashboard = () => {
    ...
    const checklistColumns = [ { key: 'id', label: 'ID' }, { key: 'machineType', label: 'Machine Type' }, { key: 'itemName', label: 'Item Name' }, { key: 'standardValue', label: 'Standard' }, { key: 'unit', label: 'Unit' } ];
    ...
    return (
        <div className="dashboard-card">
            ...
            <div className="tabs">
                ...
                <button onClick={() => setActiveTab('checklists')} className={activeTab === 'checklists' ? 'active' : ''}>Parameter Checklist</button>
            ...
            <div className="tab-content">
                ...
                {activeTab === 'checklists' && <CrudTable title="Parameter Checklist" columns={checklistColumns} endpoint="/admin/parameter-checklists" />}
