...
CREATE TABLE parameter_records (
    ...
    sq_pieces INT NULL, -- จำนวนชิ้น SQ (แยกเก็บ)
    ss_pieces INT NULL, -- จำนวนชิ้น SS (แยกเก็บ)

    -- ส่วนที่ 5: การตรวจสอบตาม PRD และหมายเหตุเพิ่มเติม
    product_quality_check NVARCHAR(50) NULL,
    machine_operation_check NVARCHAR(50) NULL,
    safety_procedure_check NVARCHAR(50) NULL,
