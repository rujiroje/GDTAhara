...
public class ParameterRecordMapper {
    ...
    /**
     * Utility method to convert Boolean to String safely
     */
    ...
    /**
     * Utility method to convert Boolean to Integer safely
     */
    ...
    /**
     * Utility method to convert String to Boolean safely
     */
    ...
    /**
     * Utility method to convert Integer to Boolean safely
     */
    ...
    public static void mapDtoToEntity(ParameterRecordRequest.ParameterData dto, ParameterRecord entity) {
        ...
        if (dto.getOtherChecks() != null) {
            entity.setCheckEmergencySwStatus(booleanToString(dto.getOtherChecks().getEmergencySw()));
            entity.setCheckSqSsPieces(booleanToInteger(dto.getOtherChecks().getSqssCheck()));
        }
    }
    ...
    public static ParameterRecordRequest.ParameterData mapEntityToDto(ParameterRecord entity) {
        ...
        // Other Checks - แก้ไขการแปลงค่าเมื่อส่งกลับ
        ParameterRecordRequest.OtherChecksDto checksDto = new ParameterRecordRequest.OtherChecksDto();
        checksDto.setEmergencySw(stringToBoolean(entity.getCheckEmergencySwStatus()));
        checksDto.setSqssCheck(integerToBoolean(entity.getCheckSqSsPieces()));
