...
public class ParameterRecord {
    ...
    @Column(name = "emergency_sw_status")
    private String checkEmergencySwStatus;
    
    @Column(name = "sq_ss_pieces")
    private Integer checkSqSsPieces;

    // New: separate SQ/SS piece counts
    @Column(name = "sq_pieces")
    private Integer sqPieces;

    @Column(name = "ss_pieces")
    ...
    public Integer getSqPieces() {
        return sqPieces;
    }

    public void setSqPieces(Integer sqPieces) {
        this.sqPieces = sqPieces;
    }

    public Integer getSsPieces() {
        return ssPieces;
    }

    public void setSsPieces(Integer ssPieces) {
        this.ssPieces = ssPieces;
    }
